...
const ConnectModal = ({ onClose, login }) => {
  const handleLogin = (connectName) => {
    login(connectName)
    onClose()
  }
  return (
    <div
      className="connnectemodal-container"
      data-aos="fade-down"
      data-aos-delay="200"
      data-aos-offset="-100"
      data-aos-easing="ease-in-out">
      <div className="connnectemodal--header aic">
        <div onClick={() => onClose()}>
          <Icon
      ...
      >
        ...
        <div className="connect-item" onClick={() => handleLogin("walletconnect")} style={{ borderRadius: "0px 0px 10px 10px" }}>
          ...
          <div className="item-header">Wallet Connect</div>
          <div className="item-desc">
